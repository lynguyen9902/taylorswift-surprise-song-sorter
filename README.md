...
<head>
    ...
    <script>
        ...
        function showResult() {
            ...
            str += "<table style=\"width:695px; font-size:18px; line-height:120%; margin-left:auto; margin-right:auto; border:1px solid #000; border-collapse:collapse\" align=\"center\">";
...
<body>
    <p class="instructions">
        ...
        please pick the song you like more. please note that choosing "i like both" or "skip for now" frequently will negatively affect your results. <br /><br />
        even if you make a mistake, do NOT click back page because all progress will be discarded.<br /><br />
        made by cln (dec 2024) as consulted the work of <a href="https://biasorter.tumblr.com/">biasorter</a> and <a href="https://jobazzle.tumblr.com/">jobazzle</a>.<br /><br />
    </p>
